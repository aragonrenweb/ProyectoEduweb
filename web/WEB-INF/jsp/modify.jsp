...
<head>
    ...
    function comboSelectionLevel()
    {
        ...
        $('#ModifyOnClick').attr('disabled', true);
    ...
    function comboSelectionSubsection()
    {
        ...
        if(document.getElementById("idsubsection").value == 0){
            ...
            $('#ModifyOnClick').attr('disabled', false);
        }
        //$('#createOnClick').attr('disabled', false);
    ...
    <body>
        <div class="container">
            <form:form id="form" method="POST" action="lessonModify.htm">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-8">
                            ...
                            <input type="hidden" class="form-control" name="TXTIdLesson" value="${lessonToModify}"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 center-block">
                            ...
                            <select class="form-control select-subjects" id="idsubjects" name="TXTsubjects" onchange="comboSelectionSubject()">
                                <option value="${subjectselection.id}" selected>${subjectselection.nombre}</option>
                        ...
                        <div class="col-xs-3 center-block">
                            ...
                            <select class="form-control select-subsection" id="idsubsection" name="TXTsubsection" onchange="comboSelectionSubsection()">
                                <option value="${SubsectionSelection.id_subsection}" selected>${SubsectionSelection.nombre_sub_section}</option>
                        ...
                        <div class='col-xs-4'>
                            <div class="form-group">
                                ...
                                <div class='input-group date' id='datetimepickerinicio'>
                                    <input type='text' name="TXTfechainicio" class="form-control" id="fechainicio" required="required" value="${fechaInicio}"/>
                        ...
                        <div class='col-xs-4'>
                            <div class="form-group">
                                ...
                                <div class='input-group date' id='datetimepickerfin'>
                                    <input type='text' name="TXTfechafin" class="form-control" required="required" value="${fechaFin}"/>
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
...
<!--script-->                          
                        ...
                        <div class="col-xs-2 pull-right">
                            <div class="form-group">
                                <label class="control-label"></label>
                                <div class='input-group' style="margin-top:19px;"> 
                                        <button type="submit" id="ModifyOnClick" value="modifyOnClick" class="btn btn-naranja" onclick="conseguirAlumnos()"><spring:message code="etiq.txtmodify"/></button>
                                </div>
                            </div>
                        </div>
                    </div>    
