...
public class Students {
    ...
    public Students(int id_students, String nombre_students, String fecha_nacimiento, String foto, int level_id) {
    ...
    public ArrayList<Students> getStudentsForLevel(int idLevel) throws SQLException{
        ...
        if(idLevel != 0){
            try {
                String consulta = "SELECT * FROM students where level_id = "+ idLevel;
                this.rs.setCommand(consulta);
                this.rs.execute(this.cn);
                this.rs.beforeFirst();
                while (rs.next())
    ...
    public ArrayList<Students> getParseStudents(String students) throws SQLException
    {
        ...
        try {
            for(int id: idAlumnos){
                String consulta = "SELECT * FROM students where id_students=" + id;
                this.rs.setCommand(consulta);
                this.rs.execute(this.cn);
                this.rs.beforeFirst();
                while (rs.next())
